              ...
              matches ? (
                <div>
                  <div className="headers">
                    <div>
                      <i className="fas fa-paw" /> {this.state.maxGuests} guests
                    </div>
                    <div>
                      <i className="fas fa-tree" />{" "}
                      {Math.ceil(this.state.maxGuests / 2)} bedrooms
                    </div>
                  </div>
                  <div className="headers">
                    <div>
                      <i className="fas fa-bed" /> {this.state.maxGuests} beds
                    </div>
                    <div>
                      <i className="fas fa-water" />{" "}
                      {Math.ceil(this.state.maxGuests / 2)} baths
                    </div>
                  </div>
                </div>
              ) : (
...
ReactDOM.render(
  <ListDesc />,
  document.getElementById("desc") || document.createElement("div")
);
